...
if(isset($_POST['login']))
  {
    ...
    $query=mysqli_query($con,"SELECT ID from signup where  username='$adminuser' && password='$password' ");
					...
					<?php if($msg)
						...
						<fieldset>
							...
							<div class="checkbox">
								...
								<a href="forgot-user-password.php" style="text-decoration:none;">Forgot Password?</a>
							</div>
				
							<button class="btn btn-success" type="submit" name="login">Login</button>
                            <div class="checkbox">
								
								<a href="signup.php" style="text-decoration:none;">User Sign Up</a>
							</div>
                        </fieldset>
					</form>
				</div>
