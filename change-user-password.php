<?php
    ...
    if(isset($_POST['change-password'])){
        ...
        $query=mysqli_query($con,"SELECT ID from signup where ID='$adminid' and   password='$cpassword'");
        $row=mysqli_fetch_array($query);

        if($row>0){
            $ret=mysqli_query($con,"update signup set password='$newpassword' where ID='$adminid'");
